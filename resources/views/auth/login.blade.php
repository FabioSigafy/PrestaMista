            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <img class=" img-fluid"src="https://app.sigafy.com.br/images/pages/login/login.png" width="350px"
                        height="250px">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-5">
                                <button type="submit" class="btn btn-primary" href="{{ route('forms.index')}}">Entrar</button>
                            </div>
                        </div>
                    </form>
                </div>
