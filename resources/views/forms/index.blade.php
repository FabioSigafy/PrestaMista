                    ...
                    <form action="{{ route('forms.index') }}" method="get">
                        <div class="card-body ">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a class="btn btn-outline-primary" href="{{ route('forms.create') }}" role="button"><i class="fa-solid fa-plus"></i>
                                    Novo</a>

                                @if (Auth::user()->{"user-master"} == 1)
                                    <a class="btn btn-outline-primary" href="{{ route('excel') }}"
                                        role="button"><i class="fa-solid fa-folder-open"></i> Relatório</a>
                                    <a class="btn btn-outline-primary" href="{{ route('register') }}" role="button"><i class="fa-solid fa-user"></i> Novo</a>
                                @endif
                        ...
                        <div class="shadow rounded mb-2 mt-3 border" style="background-color:#eeeeee">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-start m-2 ">
                                ...
                                <form action="{{ route('forms.index') }}" method="GET">
                                        ...
                                        <input type="date" class="p-2 rounded border " type="text " name="data" placeholder="Criado em">
                                        <button class="bg-primary rounded border p-2 text-light"><i class="fa-solid fa-magnifying-glass"></i> Pesquisar</button>
                                </form>
